...
def task4(cartoon_file, person_file, epochs=400):
    setup()
    # machine = StyleTransfer('Train_task/cartoon/cs10188651804540743.jpg', 'Train_task/image/000005.jpg', 333, 250)
    machine = StyleTransfer(cartoon_file, person_file, 333, 250)
    machine.build()
    machine.train(epochs)
